...
#define FUNCIONALIDADES_H
     ...
     * como fallback genérico para buscas que não possuem a chave primária (codEstacao).
    ...
    /**
     * @brief [Funcionalidade 4] Realiza a remoção lógica (tombstone) de registros baseada em filtros.
     * @param nomeArquivoBin Nome do arquivo binário de dados.
    ...
    /**
     * @brief [Funcionalidade 5] Insere novos registros reaproveitando espaços apagados (via pilha) ou no fim do arquivo.
     * @param nomeArquivoBin Nome do arquivo binário de dados.
     ...
     * Delega a pesquisa para a varredura sequencial (selectWhere) caso a chave primária não seja informada.
    ...
    /**
     * @brief [Funcionalidade 9] Insere registros no arquivo de dados mantendo a Árvore-B perfeitamente sincronizada.
    ...
    /**
     * @brief [Funcionalidade 10] Deleta registros de forma sincronizada em ambos os arquivos, priorizando busca logarítmica.
     * @param nomeArquivoDadosBin Nome do arquivo de dados.
     * @param nomeArquivoIndiceBin Nome do arquivo de índice.
